class TicketBooking:
    ...
    def __add__(self, other):
        if isinstance(other, TicketBooking):
            if other.event_name == self.event_name:
                return TicketBooking(self.event_name,
                                     self.ticket_price,
    ...
    def __eq__(self, other):
        if isinstance(other, TicketBooking):
            return other.event_name == self.event_name and other.ticket_price == self.ticket_price
        else:
            return NotImplemented
    def __bool__(self):
